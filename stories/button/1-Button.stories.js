...
const propsDescriptions = {
  ...
  color: {
    propType: 'string',
    description:
      'Define the button color. It could be either "primary" or "secondary"'
  },
  variant: {
    propType: 'string',
    description:
      'Define the button variant. It could be either "outline" or "text"'
  },
  onClick: {
    propType: 'function',
  ...
  disabled: {
    propType: 'bool',
    description:
      "Controle the button state, if it's true the button won't be no available"
  }
}
