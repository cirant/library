...
const Display = ({ col, sm, md, lg, xl }) => (
  <Grid col={col} sm={sm} md={md} className='border'>
...
export const ToStorybook = () => {
  ...
  return (
    <div className='p-7'>
      ...
      <p className='mb-4'>
        {' '}
        A col element works with col sm md lg xl props that depends up to you.
        by default the column get whole width as much as possible.
      </p>
