...
const propsDescriptions = {
  items: {
    propType: 'array',
    description:
      'Array of items who define the different blue boxes of the resume. Each box will have a title and a value.'
  }
}
  ...
  parameters: {
    info: {
      ...
      text: `
        ...
        import { VoucherResumeContainer }from 'design-system-coopeuch';
        ~~~
