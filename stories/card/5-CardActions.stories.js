      ...
      <div className='col-lg-4 col-md-12 col-sm-12 d-flex align-items-start'>
        ...
        >
          ...
          <CardContent
            ...
            content={text(
              'Content',
              'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab accusantium, aliquid at consequuntur ea eum facere ipsa',
              'Card Content'
            )}
          />
          <CardActions
            buttons={[
              {
                ...
                prefix: !boolean('prefix Icon', false, 'Button I')
                  ? null
                  : 'home',
                suffix: !boolean('suffix Icon', false, 'Button I')
                  ? null
                  : 'cloud',
              ...
              },
              {
                ...
                prefix: !boolean('prefix Icon', false, 'Button II')
                  ? null
                  : 'home',
