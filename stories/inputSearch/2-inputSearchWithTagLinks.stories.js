...
const propsDescriptions = {
  ...
  tagLinks: {
    propType: 'array',
    description: 'Define an array of tagLinks who will be displayed below of the input search component'
  }
}
...
export const inputSearchWithTagLinksh = () => (
  <InputSearch
    ...
    tagLinks={
      [
        {
          label:text('label', 'Element 01', 'TagLink I'),
          onClick:action('tagLink Clicked','','TagLink I')
        },
        {
          label:text('label', 'Element 02', 'TagLink II'),
          onClick:action('tagLink Clicked','','TagLink II')
        },
      ]
    }
  />
  ...
  parameters: {
    info: {
      ...
      text: `
        ...
        If you need more information about tagLinks please go to the documentation of the proper history [TagLink](/?path=/story/tag-link--tag-link-component)
        ~~~js
        import 'design-system-coopeuch/dist/index.css';
        import { InputSearch }from 'design-system-coopeuch';
        ~~~
