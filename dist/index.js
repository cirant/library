...
var BulletElement = function BulletElement(_ref) {
  var count = _ref.count,
      ...
      icon = _ref.icon,
      type = _ref.type,
      props = _objectWithoutPropertiesLoose(_ref, ["count", "text", "typeList", "prefixType", "contentType", "icon", "type", "variant", "active", "number", "index"]);

  var numberList = count + 1;
  var styleContainer = [styles$d.bulletElement];
  var stylePrefixContainer = [styles$d.prefixContainer];
  var styleBoxCircle = [styles$d.boxCircle];
  var styleTextContainer = [styles$d.textContainer];

  var setStyles = function setStyles(typeParam, typeListParam, prefixParam, contentParam) {
    var styleTypeContainer = [styles$d["" + typeParam]];
    ...
    if (type !== undefined) {
      ...
      var stylePrefix = [styles$d["" + prefixParam]];
      var styleContent = [styles$d["" + contentParam]];
...
var Bullets = function Bullets(_ref) {
  ...
  }, typeOfBullet === 'order' ? itemsBullets.map(function (element, index) {
...
var Tooltip2 = function Tooltip2(_ref) {
  var children = _ref.children,
