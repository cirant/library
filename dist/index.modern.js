...
const InputCore = ({
  ...
  let inputStyle = [inputStyles$1.input];
  ...
  }, prefix), variant && variant === 'textarea' ? /*#__PURE__*/React.createElement("textarea", props) : /*#__PURE__*/React.createElement("input", Object.assign({}, props, {
    onChange: onProcess
...
const Stamp = ({
  ...
  const stampSvg = /*#__PURE__*/React.createElement("svg", Object.assign({
    width: width,
    height: height,
    viewBox: "0 0 170 168"
  }, props), /*#__PURE__*/React.createElement("title", null, "01.Atomo/comprobante sello/default"), /*#__PURE__*/React.createElement("g", {
    id: "Symbols",
    stroke: "none",
    strokeWidth: "1",
    fill: "none",
    ...
    x: "25.7019298",
    y: "26.9038301"
  }, "Pago"), /*#__PURE__*/React.createElement("tspan", {
    x: "20.7769298",
    y: "41.9038301"
  }, "seguro")))))))))));
  return /*#__PURE__*/React.createElement(React.Fragment, null, stampSvg);
};
Stamp.defaultProps = {
  width: '170',
  height: '168'
...
const InputSearch = ({
  ...
  let inputContainerClases = [styles$f.inputConteiner];

  if (props.disabled) {
    inputContainerClases = inputContainerClases.concat(styles$f.disabled);
  }

  const prefix = /*#__PURE__*/React.createElement(Icon, {
    role: "search-icon",
    name: "line-search",
    size: 1
  });
  const suffix = /*#__PURE__*/React.createElement(Icon, {
    role: "cross-icon",
    onClick: clearAction,
  ...
  }, /*#__PURE__*/React.createElement(InputCore, Object.assign({}, props, {
    prefix: prefix,
    suffix: suffix
  })), /*#__PURE__*/React.createElement(Icon, {
    role: "filter-icon",
...
const InputSelect = ({
  ...
  let inputStyle = [inputStyles$2.input, inputStyles$2.hasSuffix];
  let validateStyle = [];
  ...
  const getRow = (el, key) => {
    try {
      ...
      const isDisabled = el.disabled && el.disabled === true ? inputStyles$2.disabled : '';
      return /*#__PURE__*/React.createElement("div", {
        key: key,
...
const ContentAction = ({
  ...
  let containerClass = [styles$g.contentAction];
...
const InputPhone = ({
  ...
  const getHelperText = element => {
    switch (element.type) {
      case 'success':
        return /*#__PURE__*/React.createElement("div", null, successSvg$1, " ", /*#__PURE__*/React.createElement("span", {
          className: inputStyles$3.successText
        }, element.text));

      case 'error':
        return /*#__PURE__*/React.createElement("div", null, errorSvg$1, " ", /*#__PURE__*/React.createElement("span", {
  ...
  }, countries.map(el => /*#__PURE__*/React.createElement("div", {
    role: "region",
    key: el.CODE,
  ...
  }, "+", el.CODE), " ", el.AREA)))), /*#__PURE__*/React.createElement("div", {
    className: [inputStyles$3.inputHelper].join(' ')
  }, /*#__PURE__*/React.createElement("div", null, Array.isArray(assistText) && assistText.length > 0 ? assistText.map((el, i) => /*#__PURE__*/React.createElement("div", {
    key: `${el.text}-${i}`
  }, getHelperText(el))) : assistText)));
};
...
const errorSvg$1 = /*#__PURE__*/React.createElement("svg", {
  width: "10px",
  height: "10px",
  "data-testid": "errorIcon"
}, /*#__PURE__*/React.createElement("g", {
...
const successSvg$1 = /*#__PURE__*/React.createElement("svg", {
  width: "12px",
  height: "9px",
  "data-testid": "successIcon"
}, /*#__PURE__*/React.createElement("g", {
...
export { Bullets, Button, Card, Checkbox, ContentAction, Grid, Header, HeaderItem, HeaderProfileItem, Icon, Input, InputChip, InputPhone, InputRange, InputSearch, InputSelect, Loading, Logo, Message, ProgressBar, Radio, Separator, Sidebar, SidebarElement, Stamp, Switch, TitleSection, Tooltip };
