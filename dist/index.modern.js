...
const InputSearch = ({
  ...
  let inputContainerClases = [styles$d.inputConteiner];
...
export { Button, Card, Checkbox, Grid, Header, HeaderItem, HeaderProfileItem, Icon, Input, InputChip, InputSearch, InputSelect, Loading, Logo, Message, ProgressBar, Radio, Separator, Sidebar, SidebarElement, Switch, TitleSection };
