...
describe('ProgressBar behavior', () => {
  it('should be rendered', () => {
    const component = render(
      <Message type='success' title='a title' description='a description' />
    )
  ...
  it('should be rendered as error', () => {
    ...
    expect(
      component.getByRole('message').className === 'message error'
    ).toBeTruthy()
  })
  ...
  it('should be rendered as info', () => {
    ...
    expect(
      component.getByRole('message').className === 'message info'
    ).toBeTruthy()
  })
  ...
  it('should be rendered with an action', () => {
    const component = render(
      <Message
        ...
        title=''
        description=''
        action={<Button variant='text'> ir a action </Button>}
      />
    )
