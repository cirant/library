...
const DBlackCard = ({ label, width, cardTitle, cardType, owner, state, cardNumber, ...props }) => {
  const blackCardSvg = (
    <svg width={width} height='100%' viewBox="0 0 385 209" version="1.1">
      <title>01.Atomo/Tarjetas bancarias/desktop/black</title>
      <defs>
      ...
      <g id="01.Atomo/Tarjetas-bancarias/desktop/black" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Tarjetas-bancarias">
          ...
          <rect id="Rectangle" fill="#F6F3F5" opacity="0.377092634" x="24" y="56" width="72" height="32" rx="5"></rect>
