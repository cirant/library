...
describe('ProgressBar behavior', () => {
  it('should be rendered', () => {
    ...
    expect(
      component.container.querySelector('[data-progress="25"')
    ).toBeTruthy()
  })
  ...
  it('should show percent', () => {
    ...
    expect(
      component.container.querySelector('[data-progress="75"')
    ).toBeTruthy()
    expect(component.getByRole('helper').className).toEqual(
      'bellowContent start'
    )
  })
  ...
  it('should show assistText', () => {
    const component = render(
      <ProgressBar assistText='assist text' progress={75} />
    )
  ...
  it('should show assistText to the right', () => {
    const component = render(
      <ProgressBar assistText='assist text' helperAlign='end' progress={75} />
    )
    expect(component.getByText(/assist text/)).toBeTruthy()
