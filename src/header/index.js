...
const Header = ({
  ...
  return (
    <React.Fragment>
      <Grid row className={[headerStyleContainer, Styles.headerDesktop].join(' ').trim()}>
      ...
      <Grid row className={Styles.headerMobile}>
        ...
        {
          mobile.burgerClick &&
          <Icon name="menu-burger" onClick={mobile.burgerClick} size={3} className={[
            Styles.burgerIcon,
            Styles.option
          ].join(' ').trim()} />
        }

        {
          mobile.section ?
            <Grid col className={Styles.sectionContent}>
              {
                mobile.onClickBack && <Icon name="arrow-left" onClick={mobile.onClickBack} className={Styles.backButton} size={3} />
              }
              {mobile.section}
            </Grid> :
            <Grid col>
