...
describe('Chip behavior', () => {
  it('should be rendered', () => {
    ...
    const component = render(<Chip value='chip' onClose={onClose} />)
  ...
  it('should be rendered as variant', () => {
    const onClose = jest.fn()
    const component = render(<Chip value='chip' variant onClose={onClose} />)
    expect(component).toBeTruthy()
    const hasVariant = component
      .getByText(/chip/)
      .closest('div')
  ...
  it('should be rendered as disabled', () => {
    const component = render(
      <Chip value='chip' variant onClose={() => null} disabled />
    )
    expect(component).toBeTruthy()
  ...
  it('should be pressed', () => {
    const component = render(<Chip value='chip' onClose={() => null} />)
    expect(component).toBeTruthy()
    fireEvent.mouseDown(component.container.querySelector('i'))
    const isPressed = component
      .getByText(/chip/)
      .closest('div')
      .className.match(/pressed/)
