...
describe('InputSelect behavior', () => {
  ...
  it('should be rendered with an option selected', () => {
    ...
    const component = render(
      <InputSelect label='some label' current='1' options={options} />
    )
  ...
  it('should be rendered with disabled disabled', () => {
    ...
    const component = render(
      <InputSelect current='1' disabled options={options} />
    )
    expect(component.getByRole('select').className).toEqual(
