...
describe('Bullet behavior', () => {
  ...
  it('should be render unorderlist', () => {
    ...
    const component = render(<BulletElement {...props} />)
    const unOrderList = component.getAllByTestId(
      `test-bullet-${props.typeList}`
    )
  ...
  it('should prefix bullet must render when it is a order list', () => {
    ...
    const component = render(
      <BulletElement tpyeList={`${props.typeList}`} {...props} />
    )
    const prefixContainer = component.getAllByTestId(
      `test-prefix-bullet-${props.typeList}`
    )
  ...
  it('should order list contain number', () => {
    ...
    const prefixContainer = component
      .getByTestId('test-bullet-order')
      .closest('div')
      .className.match(/bulletElement/)
    expect(prefixContainer).toBeTruthy()
  })
