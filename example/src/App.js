...
const App = () => {
  ...
  return <>
    ...
    <div className="container my-4">
      ...
      <div className="d-flex">
        <Bullets typeList="unorder" items={[
          {
            text: 'Unorder Bullet text a',
            type: 'success'
          },
          {
            text: 'Unorder Bullet text b',
            type: 'info'
          },
          {
            text: 'Unorder Bullet text c',
            type: 'warning'
          },
          {
            text: 'Unorder Bullet text d',
            type: 'error'
          }
        ]}>
        </Bullets>
    ...
    <div className="container my-4">
      ...
      <div className="d-flex">
        <Bullets typeList="order" items={[
          ...
          {
            text: 'Order Bullet text c',
            type: 'warning'
          },
          {
            text: 'Order Bullet text d',
            type: 'error'
          }
        ]}>
        </Bullets>
    ...
    <div className="container my-4">
      <h1 className="mb-4">Icons Bullets</h1>
      <div className="d-flex">
        <Bullets typeList="icons" items={[
          ...
          {
            text: 'Icon Bullet text b',
            type: 'info'
          },
          {
            text: 'Icon Bullet text c',
            type: 'warning'
          },
          {
            text: 'Icon Bullet text d',
            type: 'error'
          }
        ]}>
        </Bullets>
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-lg-12 col-md-12 col-sm-12 d-flex align-items-start">
          <Voucher stampPosition="bottom">
            <div className="container-fluid">
              <div className="row" >
                <div className="col-lg-3 col-md-12 col-sm-12 d-flex nopadding align-items-start">
                  <VoucherDataResume
                    label="Monto Bruto"
                    number={600000}
                    currency
                ...
                <div className="col-lg-3 col-md-12 col-sm-12 nopadding d-flex align-items-start">
                  <VoucherDataResume
                    label="Costo Total del credito"
                    number={600000}
                    currency
                  >
